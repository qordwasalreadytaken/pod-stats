#!/usr/bin/env python3
"""
Unique Projectiles Analysis - Unique Arrows and Bolts Usage
Analyzes characters using unique projectiles (Dragonbreath, Swiftheart, Moonfire, Frostbite, Hailstorm).
"""
...
def analyze_unique_projectiles(league="sc"):
    """Analyze characters using unique projectiles"""
    
    icons_folder = "icons"
    what_class = "Unique_Bolts_and_Arrows"
    search_tags = ["Dragonbreath", "Swiftheart", "Moonfire", "Frostbite", "Hailstorm", "FrostbiteB"]
    search_tags2 = ["Unique"]
    howmany_clusters = 6
    howmany_skills = 4
    ...
    for char_data in all_characters:
        for item in char_data.get("Equipped", []):
            if item.get("Title") in search_tags and item.get("QualityCode") == "q_unique":
        ...
        for char_data in filtered_characters:
            if 'SkillTabs' in char_data and 'Equipped' in char_data:
                ...
                for item in char_data['Equipped']:
                    ...
                    if colored_title in equipment_titles[worn_category]:
    ...
    for cluster, group in df.groupby('Cluster'):
        ...
        projectile_extras = {
            ...
            "FrostbiteB Arrows": "(Freezing Arrow Radius)",
            "FrostbiteB Bolts": "(Freezing Arrow Radius)",
        }
    ...
    <body class="not-main">
        ...
        <h1>Unique Arrows and Bolts {{ league.upper() }}core</h1>
...
if __name__ == "__main__":
    ...
    print(f"   Softcore: {sc_count} unique projectile users")
    print(f"   Hardcore: {hc_count} unique projectile users")